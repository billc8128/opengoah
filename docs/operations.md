...
Schemas 1–13 predate the authoritative Goal change stream and are intentionally not migrated. Recreate the local Goah state before starting a build that uses schema 14; `goah doctor` reports this incompatibility directly.
