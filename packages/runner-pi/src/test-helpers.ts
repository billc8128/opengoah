...
export function wakeContext(): RunRequest {
  ...
  return {
    agent:"worker",sourceWake,execution:{ id:"test-turn",sessionId:"test-session",source:"system",goalId:null,goalRevision:null,status:"in_progress",error:null,startedAt:new Date().toISOString(),endedAt:null,leaseUntil:null,leaseToken:null,runnerPid:null },
