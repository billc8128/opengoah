...
export class SqliteLedger implements Ledger {
  ...
  consumeWake(id: string, turnId: string, now: string): WakeSnapshot {
    ...
    if(!sameWakeTurnBinding(current,turn))throw new Error("consumed Wake Turn execution binding does not match");
