...
- Wake consumption validates the full execution target, while mailbox CHECK constraints preserve Human inbox/request sender-recipient boundaries during replay.
